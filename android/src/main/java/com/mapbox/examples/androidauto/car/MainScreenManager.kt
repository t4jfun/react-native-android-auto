...
class MainScreenManager(
    ...
    private var mCurrentScreen : MainCarScreen? = null
    ...
    fun currentScreen(root: Boolean = false): MainCarScreen = _currentScreen(MapboxCarApp.carAppState.value!!, root)

    private fun _currentScreen(carAppState: CarAppState,root: Boolean = false): MainCarScreen {
